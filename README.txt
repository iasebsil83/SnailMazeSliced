...
https://github.com/iasebsil83/SnailMazeSliced/tree/GfxLib
https://github.com/iasebsil83/SnailMazeSliced/tree/S2DE



If you want to access to these versions with the command git clone :

- git clone https://github.com/iasebsil83/SnailMazeSliced
- cd SnailMazeSliced
    - git checkout GfxLib
or
    - git checkout S2DE
